from . import task
from .views import TaskList, SingleTask, TaskStatus, Statuses,TaskUpdate, AdmittedPeople,\
Autogenerate
...
task.add_url_rule('/<uuid:task_id>/autogenerate', view_func=Autogenerate.as_view('autogenerate'))
